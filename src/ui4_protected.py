...
Controlador y GUI para 4 Vías con Giro Protegido (Motor NPU RKNN)
...
class SemaforoController4VProtected_RKNN(CoreSemaforoRKNN):
    def __init__(self, port=None, video_source=None, npu_core_id=None):
        super().__init__(topology_name="4_way_protected", port=port, video_source=video_source, npu_core_id=npu_core_id)
