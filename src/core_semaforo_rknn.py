...
class CoreSemaforoRKNN(CoreSemaforoBase):
    ...
    Utiliza asignación multi-núcleo (Core 0, 1 y 2 simultáneos) y cadencia adaptativa para YOLOv8 Medium.
    """
    ...
    def _predict(self, frame):
        # Cadencia temporal optimizada para YOLOv8 Medium (Inferencia intercalada + Kalman Tracking)
